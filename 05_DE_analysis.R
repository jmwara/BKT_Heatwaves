...
usp9.plot <- ggplot()+ 
  ...
  theme_classic()+ #change the plot theme to make it look neater
  #facet_wrap(~Site, nrow=1)+ #facet the plot by Site so the differences can be seen more easily
  labs(x=" ", y=" ", title=expression(paste("USP9X.2.4 (", italic("usp9"),")"))) #edit the axis labels
...
ggsave("Figure5.jpeg", DEgene.plots, width=18, height=12, units="in", dpi=300) #save a jpeg of Figure 5
