...
library(WGCNA)
library(data.table)
salmon_data <- fread("~/scratch/BrookTrout_Analyses/WGCNA/salmon_logcounts_environ.txt", drop=1) #read in dataset with environmental and expression data
...
save(MEs, moduleLabels, moduleColors, geneTree, file="~/scratch/BrookTrout_Analyses/WGCNA/BrookTroutHeatwave_netwrkConstruction_auto.RData") #save these results to an .RData file 
